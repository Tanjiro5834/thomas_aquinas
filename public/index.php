            ...
            <div class="bg-white rounded-3xl overflow-hidden shadow-xl grid md:grid-cols-3">
                ...
                <div class="md:col-span-2 h-[400px] relative bg-gray-200">
                    ...
                    <div class="absolute inset-0 flex items-center justify-center flex-col text-gray-400">
                        ...
                        <p class="font-bold">Interactive Campus Map Loading...</p>
                        <p class="text-xs mt-2">Find us at Buhay na Tubig, Imus</p>
                    </div>
    ...
    <script>
        ...
        const programs = {
            preschool: {
                ...
                strands: [
                    { name: 'Nursery', desc: 'Introduction to social skills and motor development through sensory play.' },
                    { name: 'Kindergarten', desc: 'Preparing young learners with foundational literacy and numeracy skills.' }
                ]
            },
            elementary: {
                title: 'Elementary',
                ...
                strands: [
                    { name: 'Primary (Grades 1-3)', desc: 'Mastering reading, writing, and basic mathematics.' },
                    { name: 'Intermediate (Grades 4-6)', desc: 'In-depth exploration of Science, Social Studies, and Creative Arts.' }
                ]
            },
            jhs: {
                ...
                strands: [
                    { name: 'General Curriculum', desc: 'Robust academic training covering standard K-12 requirements with heavy values integration.' }
                ]
            },
            shs: {
                ...
                strands: [
                    { name: 'STEM', desc: 'Science, Technology, Engineering, and Mathematics. Focus on research and technical skills.' },
                    { name: 'ABM', desc: 'Accountancy, Business, and Management. Training for future entrepreneurs and corporate leaders.' },
                    { name: 'HUMSS', desc: 'Humanities and Social Sciences. For students pursuing Law, Communication, or Teaching.' },
                    { name: 'GAS', desc: 'General Academic Strand. A flexible path for undecided college majors.' }
                ]
            }
        };
